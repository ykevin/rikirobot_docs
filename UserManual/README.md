...
* 2.3、打开上位机电脑并连上网络，打开树莓派并连接上网络，检查网络的连通性，请保证你的虚拟机与树莓派的网络都在同一个网段，如何查看Liunx下的IP请用ifconfig命令查看，比如：树莓派的IP是192.168.1.xx网段，那此时虚拟机也应该是192.168.1.xx网段(一定、一定、一定要在同一网段)，如果网络连通，则系统正常，如果不通请检查网络，如果相互能ping通ip则网络正常。
